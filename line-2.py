...
#         if char == ' ':
#           continue
#         if char.isupper() and "shift" not in alphabet:
#           alphabet.append("shift")
#         if char.islower() and char not in alphabet:
#           alphabet.append(char)
#     answer = -1
#     for set in combinations(alphabet, n):
#       score = 0
#       for sentence in sentences:
#         sentenceScore = 0
#         for char in sentence:
...
#           else:
#             if char.isupper():
#               if "shift" in set and char.lower() in set:
#                 sentenceScore += 2
#             elif char == ' ':
#               sentenceScore += 1
#               continue
